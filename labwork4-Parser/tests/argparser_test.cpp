...
TEST(ArgParserTestSuite, SignIntTest) {
    ArgParser parser("My Parser");
    parser.AddIntArgument("param1");
    parser.AddIntArgument('p', "param2");
    parser.AddIntArgument("param3");

    ASSERT_TRUE(parser.Parse(SplitString("app --param1 -100500 -p -239 --param3=-239239")));
    ASSERT_EQ(parser.GetIntValue("param1"), -100500);
    ASSERT_EQ(parser.GetIntValue("param2"), -239);
    ASSERT_EQ(parser.GetIntValue("param3"), -239239);
}
