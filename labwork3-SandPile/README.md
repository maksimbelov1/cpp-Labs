...
1. 29.10.24 23:59 - 0.8
2. 05.11.24 23:59 - 0.65
3. 12.11.24 23:59 - 0.5


### PS
(в качестве доп таски сделал, чтобы входной файл мог быть bmp (количество песчинок в точке равно сумме значений цвета в RGB))